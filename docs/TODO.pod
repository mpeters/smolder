...
Auto-purging of old data configurable in smolder.conf
...
Add paging to other listing pages admin_developers/admin_projects, etc (possibly add sortable table as well)
...
Allow anonymous test reports from public (add extra 'anonymous' user?)
...
Show test reports/graphs to the public
...
Verify and test support for non AJAX browsers
