...
=item * Change the UI for assigning developers to projects to allow for larger lists of groups and developers

=item * Upgraded 3rd party JavaScript libraries (prototype, scriptaculous) and remove unnecssary JS and CSS files

=item * Fixed bug where emails weren't being sent out.
