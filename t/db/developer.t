...
ok($projects[0]->id == $proj_devs[0]->project->id || $projects[0]->id == $proj_devs[1]->project->id);
ok($projects[1]->id == $proj_devs[0]->project->id || $projects[1]->id == $proj_devs[1]->project->id);
